...
-- |
module HaskellInDepth.Chapter3.StatReport where

import Colonnade (ascii, headed)
import Data.Foldable (maximumBy, minimumBy)
import Data.Ord (comparing)
import Data.Time (diffDays)
import Fmt (Buildable, Builder, build, fixedF, pretty, (+|), (+||), (|+), (||+))
import HaskellInDepth.Chapter3.QuoteData (QField (..), QuoteData (..), field2fun)
